...
const Contact: React.FC = () => {
    return (
        <div className="min-h-screen bg-background">
            {/* Hero Section */}
            <div className="relative h-[400px] overflow-hidden bg-gradient-to-br from-red-600 via-red-700 to-red-800">
                ...
                <div className="relative container mx-auto px-4 h-full flex items-center">
                    <div className="w-full text-white z-10 text-center">
                        <h1 className="text-4xl md:text-5xl font-bold mb-6 animate-fade-in">
                            Contact <span className="text-red-200">Support</span>
                        </h1>
                        <p className="text-xl mb-8 text-red-100 animate-slide-up max-w-2xl mx-auto leading-relaxed">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6">
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="flex items-start">
                                    <div className="bg-red-100 dark:red-900/30 p-3 rounded-lg mr-4">
                                        <svg className="w-6 h-6 text-red-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
