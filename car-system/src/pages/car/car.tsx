...
//       // Fetch available cars (filtered)
//       const allCarsRes = await carService.getAllCars();
//       const allCars = allCarsRes.data;

//       // Filter on client: only available, and match search
//       const filteredAvailableCars = allCars.filter(
//         (car) =>
//           car.isAvailable &&
//           (!search ||
//             car.make.toLowerCase().includes(search.toLowerCase()) ||
...
//       setAvailableCars(filteredAvailableCars);

//       // Filter rented cars by logged-in user (mock or actual logic)
//       const rented = await carService.getUserRentedCars();
//       setRentedCars(rented);
//     } catch (error) {
//       console.error("Failed to fetch cars:", error);
//     } finally {
