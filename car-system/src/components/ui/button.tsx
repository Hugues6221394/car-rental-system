  ...
  "inline-flex items-center justify-center rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-blue-500 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-gray-200 bg-white shadow-sm hover:bg-gray-100 hover:text-blue-600 dark:border-navy-700 dark:bg-navy-800 dark:hover:bg-navy-700 dark:hover:text-blue-400",
        secondary:
          "bg-gray-100 text-gray-900 shadow-sm hover:bg-gray-200 dark:bg-navy-700 dark:text-gray-100 dark:hover:bg-navy-600",
        ghost:
          "hover:bg-gray-100 hover:text-blue-600 dark:hover:bg-navy-700 dark:hover:text-blue-400",
