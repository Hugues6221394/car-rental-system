...
public class PaymentController {
    ...
    public ResponseEntity<ApiResponse<PaymentDTO>> getPaymentByReservationId(@PathVariable Long reservationId) {
        try {
    ...
    // Add endpoint to initiate payment
    @PostMapping("/initiate")
    public ResponseEntity<ApiResponse<PaymentDTO>> initiatePayment(@RequestParam Long reservationId) {
        try {
            PaymentDTO payment = paymentService.initiatePayment(reservationId);
